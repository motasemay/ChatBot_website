...
function Navbar() {
  ...
  return (
    // <nav className="navbar navbar-expand-lg navbar-light z-3 bg-dark-subtle ">
    //   <div className="container-lg">
    //     {/*  Brand */}
    //     <a className="navbar-brand d-lg-none" href="./index.html">asdfasdf</a>
    //     {/* Toggler */}
    ...
    //           <a className="nav-link dropdown-toggle" id="landingsDropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">
    //             Landings
    //           </a>
    //           <div className="dropdown-positioner" style={{ position: 'absolute', inset: '0px auto auto 0px', margin: 0, transform: 'translate3d(134.579px, -15.8878px, 0px)' }} data-popper-placement="right">
    //             <div className="dropdown-menu dropdown-menu-xl dropdown-menu-flush" aria-labelledby="landingsDropdown">
    //               <div className="row align-items-center gx-0">
    //                 <div className="col-md-6 order-1 dropdown-menu-col rounded-top-start-0 bg-gray-900 pt-4 py-lg-5">
    ...
    //                       {/* Icon */}
    //                       <div className="icon icon-sm text-primary-light">
    //                         <svg width={24} height={24} viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><g fill="none" fillRule="evenodd"><path d="M0 0h24v24H0z" /><path d="M4.002 12.2L13 14V4.062A8.001 8.001 0 0112 20a8 8 0 01-7.998-7.8z" fill="#335EEA" opacity=".3" /><path d="M3.06 10.012A8.001 8.001 0 0111 3v8.6l-7.94-1.588z" fill="#335EEA" /></g></svg>        </div>
    //                       <div className="ms-3">
    //                         {/* Heading */}
    //                         <p className="fw-bold mb-0">
    //                           Analytics SaaS
    ...
    //                         <input className="form-check-input family-switch" type="checkbox" id="familySwitch" onchange="switchFamily(this.checked)" />
    //                         <label className="form-check-label" htmlFor="familySwitch" />
    //                       </div>
    //                     </form>
    //                   </div>
    //                 </div>
    ...
    //         </li>
    //         <li className="nav-item dropdown">
    //           <a className="nav-link dropdown-toggle" id="pagesDropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">
    //             Pages
    //           </a>
    //           <div className="dropdown-positioner" style={{ position: 'absolute', inset: '0px auto auto 0px', margin: 0, transform: 'translate3d(-137.383px, 44.8598px, 0px)' }} data-popper-placement="bottom">
    ...
    //       </ul>
    //       {/* Brand */}
    //       <a className="navbar-brand d-none d-lg-block px-lg-6" href="./index.html">Bilsan chatbot</a>
    //       {/* Navigation */}
    //       <ul className="navbar-nav justify-content-start w-100">
    //         <li className="nav-item dropdown">
    //           <a className="nav-link dropdown-toggle" id="accountDropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">
    //             Account
    //           </a>
    //           <div className="dropdown-positioner" style={{ position: 'absolute', inset: '0px 0px auto auto', margin: 0, transform: 'translate3d(-129.907px, 22.4299px, 0px)' }} data-popper-placement="left">
    //             <ul className="dropdown-menu" aria-labelledby="accountDropdown">
    //               <li className="dropdown-item dropend">
    //                 <a className="dropdown-link dropdown-toggle" id="signInDropright" href="#" role="button" aria-haspopup="true" aria-expanded="false">
    //                   Sign In
    //                 </a>
    ...
    //                       Simple
    //                     </a>
    //                     <a className="dropdown-item" data-bs-toggle="modal" href="#modalSignIn">
    //                       Modal
    //                     </a>
    //                   </div>
    //                 </div>
    //               </li>
    //               <li className="dropdown-item dropend">
    //                 <a className="dropdown-link dropdown-toggle" id="signUpDropright" href="#" role="button" aria-haspopup="true" aria-expanded="false">
    //                   Sign Up
    //                 </a>
    //                 <div className="dropdown-positioner">
    ...
    //                       Simple
    //                     </a>
    //                     <a className="dropdown-item" data-bs-toggle="modal" href="#modalSignUp">
    //                       Modal
    //                     </a>
    //                   </div>
    //                 </div>
    //               </li>
    //               <li className="dropdown-item dropend">
    //                 <a className="dropdown-link dropdown-toggle" id="passwordResetDropright" href="#" role="button" aria-haspopup="true" aria-expanded="false">
    //                   Password Reset
    //                 </a>
    //                 <div className="dropdown-positioner">
    ...
    //                       Simple
    //                     </a>
    //                     <a className="dropdown-item" data-bs-toggle="modal" href="#modalPasswordReset">
    //                       Modal
    //                     </a>
    //                   </div>
    //                 </div>
    //               </li>
    //               <li className="dropdown-item dropend">
    //                 <a className="dropdown-link dropdown-toggle" id="errorsDropright" href="#" role="button" aria-haspopup="true" aria-expanded="false">
    //                   Errors
    //                 </a>
    //                 <div className="dropdown-positioner">
    ...
    //         </li>
    //         <li className="nav-item dropdown">
    //           <a className="nav-link dropdown-toggle" id="docsDropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">
    //             Docs
    //           </a>
    //           <div className="dropdown-positioner" style={{ position: 'absolute', inset: '0px 0px auto auto', margin: 0, transform: 'translate3d(-101.869px, 22.4299px, 0px)' }} data-popper-placement="left">
    ...
    //             <form className="ms-auto me-n3">
    //               <div className="form-check form-switch mb-0">
    //                 <input className="form-check-input family-switch" type="checkbox" id="familySwitchMobile" onchange="switchFamily(this.checked)" />
    //                 <label className="form-check-label" htmlFor="familySwitchMobile" />
    //               </div>
    //             </form>
    //           </div>
    //         </li>
