...
function Chatbot() {
    ...
    //         if (messages.length > 0 || messageInputRef.current.value.trim() !== "") {
    //             setShowSuggestions(false);
    //         } else {
    ...
    //     checkForMessages();
    //     // messageInputRef.current.addEventListener('input', checkForMessages);


    //     if (messageInputRef.current) { // Check if ref is valid
    //         inputListener = checkForMessages; // Assign to variable
    //         messageInputRef.current.addEventListener('input', inputListener);
    //     }


    //     return () => {
    //         // messageInputRef.current.removeEventListener('input', checkForMessages);

    //         if (messageInputRef.current && inputListener) {  
    //             messageInputRef.current.removeEventListener('input', inputListener);
    //         }
    //     };
    // }, [messages]);
                ...
                <div className={chatStyle.chatContainer}>
                    ...
                    <div className={chatStyle.chatHeader}>
                        ...
                        <div className={chatStyle.mContainer}>
                            ...
                            <span className={chatStyle.companyName}>FusionIQ</span>
                            <span>Chatbot</span>
                        </div>
                    ...
                    <div className={chatStyle.chatMessages} ref={chatMessagesRef}>
                               ...
                               {showSuggestions &&  messages.length === 0 && (
                                <div className={`${chatStyle.suggestedQuestions} ${!showSuggestions ? chatStyle.hide : ''}`}>
